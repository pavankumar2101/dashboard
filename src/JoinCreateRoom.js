    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12 border-dark">
          <h1 className="text-center my-5 bg-info rounded p-3 mx-auto">
            Welcome To Collaborative Whiteboard Sharing App
          </h1>
        </div>
      </div>
      <div className="row mx-5 mt-5">
        <div className="col-md-5 p-5  border rounded border-dark mx-auto">
          <h1 className="text-center text-dark mb-5">Create Room</h1>
        ...
        <div className="col-md-5 p-5 border rounded mx-auto bg-info border-dark">
          <h1 className="text-center text-dark mb-5">Join Room</h1>
